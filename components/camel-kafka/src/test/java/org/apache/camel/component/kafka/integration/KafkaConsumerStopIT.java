...
public class KafkaConsumerStopIT extends BaseEmbeddedKafkaTestSupport {
    ...
    private org.apache.kafka.clients.consumer.KafkaConsumer getKafkaClientConsumer() throws Exception {
        ...
        Try<Object> kafkaClientConsumerTry = ReflectionUtils.tryToReadFieldValue(KafkaFetchRecords.class, "consumer", kafkaFetchRecords);
        return (org.apache.kafka.clients.consumer.KafkaConsumer) kafkaClientConsumerTry.get();
    }

    private static boolean kafkaClientConsumerClosed(org.apache.kafka.clients.consumer.KafkaConsumer kafkaClientConsumer) throws Exception {
        Try<Object> closedTry = ReflectionUtils.tryToReadFieldValue(org.apache.kafka.clients.consumer.KafkaConsumer.class, "closed", kafkaClientConsumer);
